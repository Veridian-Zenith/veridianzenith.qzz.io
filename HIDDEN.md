# Veridian Zenith — Hidden Runes

This document tracks the discrete micro-interactions, easter eggs, and "hidden" features built into the digital realm.

## Current Easter Eggs
1. **The Zenith Sigil Secret**: Hovering over the VZ logo in the Navbar for more than 3 seconds triggers a "Sigil Pulse" animation.
2. **Void Latency Feedback**: Clicking the latency number in the loading screen (if you catch it) cycles between diagnostic modes.
